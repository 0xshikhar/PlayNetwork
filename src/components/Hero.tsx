...
const style = {
    wrapper: `relative w-screen bg-[url('https://shikhar.xyz/wp-content/uploads/2023/06/hero.png')] `,
    container: `before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-center before:opacity-100 `,
                ...
                <div className={style.contentWrapper}>
                    <div className={style.copyContainer}>
                        ...
                        <div className={style.title}>
                            Stream & Organize Games on Near Blockchain
                        </div>
